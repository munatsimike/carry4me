...
-- 2. Insert payment window setting (10 minutes for testing)
INSERT INTO public.platform_settings (key, value, description)
VALUES (
  'payment_window_minutes',
  '10',
  'Number of minutes allowed for payment before a carry request expires'
)
ON CONFLICT (key) DO UPDATE
SET value = EXCLUDED.value;

-- 3. Update perform_carry_request_action function
...
BEGIN
  ...
  -- Load payment window from platform settings
  SELECT value::int
