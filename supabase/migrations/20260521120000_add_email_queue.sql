...
create index if not exists email_queue_notification_id_idx
  on public.email_queue (notification_id);

create unique index if not exists email_queue_notification_id_unique_idx
  on public.email_queue (notification_id);
