  ...
  switch (actionKey) {
    case UIACTIONKEYS.ACCEPT:
      ...
      return {
        ...
        message:
          `You are committing to carry this parcel and will be responsible for it from receipt until delivery. The sender will be notified and has ${formatPaymentWindowLabel()} to pay and confirm the booking.`,
